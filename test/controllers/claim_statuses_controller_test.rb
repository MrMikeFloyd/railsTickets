...
class ClaimStatusesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create claim_status" do
    assert_difference('ClaimStatus.count') do
      post claim_statuses_url, params: { claim_status: { description: @claim_status.description, name: @claim_status.name } }
    end
  ...
  test "should update claim_status" do
    patch claim_status_url(@claim_status), params: { claim_status: { description: @claim_status.description, name: @claim_status.name } }
